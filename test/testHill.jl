...
# guess
guess = [125.0, 0.04, 0.007, 0.005, 0.007, 0.005, 39.0, 30.0, 11.0, 20.0, 125.0, 0.003, 125.0, 0.02]
...
# upper bound
high = [250, 0.01, 0.02, 0.1, 0.2, 0.03, 40.0, 35.0, 15.0, 20.0, 250.0, 0.05, 250.0, 0.1]

# do the optimization
println("### lapatinib ###")
best_fitL, pt_l = optimize_hill(guess, conc_l, g1l, g2l, g1_0l, g2_0l, num_steps, 50.0, 150.0)
