...
function SSEs_combination()
    ...
    SSEs[1,2] = (norm(Bliss_cellnum[:, 4:5, 5, 9] - meanGS2[3, 1:189, 21:22]) + norm(Bliss_cellnum[:, 7, 5, 9] - meanGS2[3, 1:189, 24]) + norm(palbo50gem17_cellnum - meanGS2[3, 1:189, 23])) / 4
    ...
    SSEs[1,5] = (norm(Bliss_cellnum[:, 4, 5:6, 5] - meanGS2[3, 1:189, 15:16]) + norm(dox20gem17_cellnum - meanGS2[3, 1:189, 17]) + norm(Bliss_cellnum[:, 4, 7, 5] - meanGS2[3, 1:189, 18])) / 4
    ...
    SSEs[1,7] = (norm(Bliss_cellnum[:, 6, 4, 4] - meanGS2[3, 1:189, 8]) + norm(Bliss_cellnum[:, 6, 6, 4] - meanGS2[3, 1:189, 14]) + norm(Bliss_cellnum[:, 6, 7, 4] - meanGS2[3, 1:189, 20])) / 3
    SSEs[2,7] = (norm(Lap100palbo[3, :, 1] - meanGS2[3, 1:189, 8]) + norm(Lap100palbo[3, :, 2] - meanGS2[3, 1:189, 14]) + norm(Lap100palbo[3, :, 3] - meanGS2[3, 1:189, 20])) / 3
...
function helper(Bliss_model1, Bliss_model2, i, title, subPlabel, label, GS2)
    t = LinRange(0.0, 95.0, 189)
    p = plot(t, Bliss_model1 .+ Bliss_model2, label="total $label", xlabel="time [hr]", lw=3, ylabel="cell number", color="black", legend=:topright, title=title, titlefont = Plots.font("Helvetica", 12), guidefont=Plots.font("Helvetica", 12), xtickfont=Plots.font("Helvetica", 12),ytickfont=Plots.font("Helvetica", 12), bottom_margin=1.5cm, fg_legend = :transparent, top_margin=1.25cm, left_margin=1.25cm, right_margin=1.25cm)
    plot!(t, mean(GS2, dims = 4)[3, 1:189, i], ribbon= std(GS2, dims=4)[3, 1:189, i], alpha=0.1, label="", legend=:topright, titlefont = Plots.font("Helvetica", 12), lw=3, color="gray", guidefont=Plots.font("Helvetica", 12), xtickfont=Plots.font("Helvetica", 12),ytickfont=Plots.font("Helvetica", 12), bottom_margin=1.5cm, fg_legend = :transparent, top_margin=1.25cm, left_margin=1.25cm, right_margin=1.25cm)
    plot!(t, Bliss_model1, label="G1 $label", xlabel="time [hr]", lw=3, ylabel="cell number", color="mediumseagreen", titlefont = Plots.font("Helvetica", 12), guidefont=Plots.font("Helvetica", 12), xtickfont=Plots.font("Helvetica", 12),ytickfont=Plots.font("Helvetica", 12), bottom_margin=1.5cm, fg_legend = :transparent, top_margin=1.25cm, left_margin=1.25cm, right_margin=1.25cm)
    plot!(t, Bliss_model2, label="G2 $label", titlefont = Plots.font("Helvetica", 12), lw=3, color="mediumpurple3", guidefont=Plots.font("Helvetica", 12), xtickfont=Plots.font("Helvetica", 12),ytickfont=Plots.font("Helvetica", 12), bottom_margin=1.5cm, fg_legend = :transparent, top_margin=1.25cm, left_margin=1.25cm, right_margin=1.25cm)
    plot!(t, mean(GS2, dims = 4)[1, 1:189, i], ribbon= std(GS2, dims=4)[1, 1:189, i], alpha=0.1, label="", titlefont = Plots.font("Helvetica", 12), lw=3, color="darkseagreen3", guidefont=Plots.font("Helvetica", 12), xtickfont=Plots.font("Helvetica", 12),ytickfont=Plots.font("Helvetica", 12), bottom_margin=1.5cm, fg_legend = :transparent, top_margin=1.25cm, left_margin=1.25cm, right_margin=1.25cm)
    plot!(t, mean(GS2, dims = 4)[2, 1:189, i], ribbon=std(GS2, dims=4)[2, 1:189, i], alpha=0.1, label="", titlefont = Plots.font("Helvetica", 12), lw=3, color="plum", guidefont=Plots.font("Helvetica", 12), xtickfont=Plots.font("Helvetica", 12),ytickfont=Plots.font("Helvetica", 12), bottom_margin=1.5cm, fg_legend = :transparent, top_margin=1.25cm, left_margin=1.25cm, right_margin=1.25cm)
