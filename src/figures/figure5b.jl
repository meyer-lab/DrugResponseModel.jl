...
x1 = ["control" "gem 10 nM" "gem 10 nM + lap 25 nM" "gem 10 nM + lap 50 nM" "gem 10 nM + lap 100 nM" "gem 10 nM + lap 250 nM"]
# x2 = ["control" "palbo 25 nM" "palbo 50 nM" "palbo 100 nM" "palbo 250 nM"]
x2 = ["control" "lap 25 nM" "lap 50 nM" "lap 100 nM" "lap 250 nM"]
...
function plot_separate()
    ...
    p1 = DrugResponseModel.plot_fig5(t, GCsim[1, :, :, 1], GC[1, 1:189, :, 1], x1, "Gem 10 + Lap combo", "G1", "A")
    p4 = DrugResponseModel.plot_fig5(t, GCsim[2, :, :, 1], GC[2, 1:189, :, 1], x1, "Gem 10 + Lap combo", "G2", "B")
    p2 = DrugResponseModel.plot_fig5(t, gc_singlesim[1, :, :, 1], g1m[:, [1, 4, 5, 6, 7], 1], x2, "Lap alone", "G1", "C")
    p5 = DrugResponseModel.plot_fig5(t, gc_singlesim[2, :, :, 1], g2m[:, [1, 4, 5, 6, 7], 1], x2, "Lap alone", "G2", "D")
    p3 = DrugResponseModel.plot_fig5(t, gc_singlesim[1, :, :, 2], g1m[:, [1, 4, 5, 6, 7], 3], x3, "Gem alone", "G1", "E")
    p6 = DrugResponseModel.plot_fig5(t, gc_singlesim[2, :, :, 2], g2m[:, [1, 4, 5, 6, 7], 3], x3, "Gem alone", "G2", "F")
    fig5b = plot(p1, p2, p3, p4, p5, p6, size = (1200, 600), layout = (2, 3))
    savefig(fig5b, "figure5b2.svg")
end