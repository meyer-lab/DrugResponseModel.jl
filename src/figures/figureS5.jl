...
function figureS5()
    ...
    p3 = plot_pCombo(combinEffects[1:6, :, 2], single_effs[1:6, end, 2], "Gem", 10.95, "Palbo 50 nM", "Palbo 50 nM + Gem", "progression rates [1/hr]", "C", 0.35)
    p4 = plot_pCombo(combinEffects[7:12, :, 2], single_effs[1:6, end, 2], "Gem", 2.5, "Palbo 50 nM", "Palbo 50 nM + Gem", "death rates [1/hr]", "D", 0.06)
    p5 = plot_pCombo(combinEffects[1:6, :, 3], single_effs[1:6, end, 3], "Palbo", 10.95, "Gem 10 nM", "Gem 10 nM + Palbo", "progression rates [1/hr]", "E", 0.35)
    p6 = plot_pCombo(combinEffects[7:12, :, 3], single_effs[1:6, end, 3], "Palbo", 2.5, "Gem 10 nM", "Gem 10 nM + Palbo", "death rates [1/hr]", "F", 0.06)
    ...
    p9 = plot_pCombo(combinEffects[1:6, :, 5], single_effs[1:6, end, 1], "Lap", 10.95, "Palbo 50 nM", "Palbo 50 nM + Lap", "progression rates [1/hr]", "C", 0.35)
    p10 = plot_pCombo(combinEffects[7:12, :, 5], single_effs[7:12, end, 1], "Lap", 2.5, "Palbo 50 nM", "Palbo 50 nM + Lap", "death rates [1/hr]", "D", 0.06)
