...
function plot_hillCurves()
    ...
    p1 = plot(
        concs[:, 1],
        new_PS[:, :, 1]',
        labels = ["G1 prog." "G2 prog." "G1 death" "G2 death"],
        title = "lapatinib effects",
