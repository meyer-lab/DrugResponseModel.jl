...
function output_combination()
    ...
    # G1
    df1 = DataFrames.DataFrame(palbo50c=palbo_alone[1, :, 2], palbo50_lpt25=palbo50Lap[1, :, 1], palbo50_lpt50=palbo50Lap[1, :, 2], palbo50_lpt100=palbo50Lap[1, :, 3],palbo50_lpt250=palbo50Lap[1, :, 4], 
    palbo50=palbo_alone[1, :, 2], palbo50_gem5=palbo50Gem[1, :, 1], palbo50_gem10=palbo50Gem[1, :, 2], palbo50_gem17=palbo50Gem[1, :, 3], palbo50_gem30=palbo50Gem[1, :, 4],
    gem10c=gemcitabine_alone[1, :, 2], gem10lpt25=Gem10Lap[1, :, 1], gem10lpt50=Gem10Lap[1, :, 2], gem10lpt100=Gem10Lap[1, :, 3], gem10lpt250=Gem10Lap[1, :, 4],
    gem10=gemcitabine_alone[1, :, 2], gem10_palbo25=Gem10palbo[1, :, 1], gem10_palbo50=Gem10palbo[1, :, 2], gem10_palbo100=Gem10palbo[1, :, 3], gem10_palbo250=Gem10palbo[1, :, 4],
    lpt100c=lapatinib_alone[1, :, 3], lpt100palbo25=Lap100palbo[1, :, 1], lpt100palbo50=Lap100palbo[1, :, 2], lpt100palbo100=Lap100palbo[1, :, 3], lpt100palbo250=Lap100palbo[1, :, 4],
    lpt100=lapatinib_alone[1, :, 3], lpt100_gem5=lap100gem[1, :, 1], lpt100_gem10=lap100gem[1, :, 2], lpt100_gem17=lap100gem[1, :, 3], lpt100_gem30=lap100gem[1, :, 4],
    dox20=dox_alone[1, :], dox20_gem5=dox20gem[1, :, 1], dox20_gem10=dox20gem[1, :, 2], dox20_gem17=dox20gem[1, :, 3], dox20_gem30=dox20gem[1, :, 4],
    pax2=pax2_alone[1, :], pax2_lpt25=Pax2_lap[1, :, 1], pax2_lpt50=Pax2_lap[1, :, 2], pax2_lpt100=Pax2_lap[1, :, 3], pax2_lpt250=Pax2_lap[1, :, 4])

    # G2
    df2 = DataFrames.DataFrame(palbo50c=palbo_alone[2, :, 2], palbo50_lpt25=palbo50Lap[2, :, 1], palbo50_lpt50=palbo50Lap[2, :, 2], palbo50_lpt100=palbo50Lap[2, :, 3],palbo50_lpt250=palbo50Lap[2, :, 4], 
    palbo50=palbo_alone[2, :, 2], palbo50_gem5=palbo50Gem[2, :, 1], palbo50_gem10=palbo50Gem[2, :, 2], palbo50_gem17=palbo50Gem[2, :, 3], palbo50_gem30=palbo50Gem[2, :, 4],
    gem10c=gemcitabine_alone[2, :, 2], gem10lpt25=Gem10Lap[2, :, 1], gem10lpt50=Gem10Lap[2, :, 2], gem10lpt100=Gem10Lap[2, :, 3], gem10lpt250=Gem10Lap[2, :, 4],
    gem10=gemcitabine_alone[2, :, 2], gem10_palbo25=Gem10palbo[2, :, 1], gem10_palbo50=Gem10palbo[2, :, 2], gem10_palbo100=Gem10palbo[2, :, 3], gem10_palbo250=Gem10palbo[2, :, 4],
    lpt100=lapatinib_alone[2, :, 3], lpt100palbo25=Lap100palbo[2, :, 1], lpt100palbo50=Lap100palbo[2, :, 2], lpt100palbo100=Lap100palbo[2, :, 3], lpt100palbo250=Lap100palbo[2, :, 4],
    lpt100c=lapatinib_alone[2, :, 3], lpt100_gem5=lap100gem[2, :, 1], lpt100_gem10=lap100gem[2, :, 2], lpt100_gem17=lap100gem[2, :, 3], lpt100_gem30=lap100gem[2, :, 4],
    dox20=dox_alone[2, :], dox20_gem5=dox20gem[2, :, 1], dox20_gem10=dox20gem[2, :, 2], dox20_gem17=dox20gem[2, :, 3], dox20_gem30=dox20gem[2, :, 4],
    pax2=pax2_alone[2, :], pax2_lpt25=Pax2_lap[2, :, 1], pax2_lpt50=Pax2_lap[2, :, 2], pax2_lpt100=Pax2_lap[2, :, 3], pax2_lpt250=Pax2_lap[2, :, 4])

    # total
    df3 = DataFrames.DataFrame(palbo50c=palbo_alone[3, :, 2], palbo50_lpt25=palbo50Lap[3, :, 1], palbo50_lpt50=palbo50Lap[3, :, 2], palbo50_lpt100=palbo50Lap[3, :, 3],palbo50_lpt250=palbo50Lap[3, :, 4], 
    palbo50=palbo_alone[3, :, 2], palbo50_gem5=palbo50Gem[3, :, 1], palbo50_gem10=palbo50Gem[3, :, 2], palbo50_gem17=palbo50Gem[3, :, 3], palbo50_gem30=palbo50Gem[3, :, 4],
    gem10c=gemcitabine_alone[3, :, 2], gem10lpt25=Gem10Lap[3, :, 1], gem10lpt50=Gem10Lap[3, :, 2], gem10lpt100=Gem10Lap[3, :, 3], gem10lpt250=Gem10Lap[3, :, 4],
    gem10=gemcitabine_alone[3, :, 2], gem10_palbo25=Gem10palbo[3, :, 1], gem10_palbo50=Gem10palbo[3, :, 2], gem10_palbo100=Gem10palbo[3, :, 3], gem10_palbo250=Gem10palbo[3, :, 4],
    lpt100c=lapatinib_alone[3, :, 3], lpt100palbo25=Lap100palbo[3, :, 1], lpt100palbo50=Lap100palbo[3, :, 2], lpt100palbo100=Lap100palbo[3, :, 3], lpt100palbo250=Lap100palbo[3, :, 4],
    lpt100=lapatinib_alone[3, :, 3], lpt100_gem5=lap100gem[3, :, 1], lpt100_gem10=lap100gem[3, :, 2], lpt100_gem17=lap100gem[3, :, 3], lpt100_gem30=lap100gem[3, :, 4],
    dox20=dox_alone[3, :], dox20_gem5=dox20gem[3, :, 1], dox20_gem10=dox20gem[3, :, 2], dox20_gem17=dox20gem[3, :, 3], dox20_gem30=dox20gem[3, :, 4],
    pax2=pax2_alone[2, :], pax2_lpt25=Pax2_lap[3, :, 1], pax2_lpt50=Pax2_lap[3, :, 2], pax2_lpt100=Pax2_lap[3, :, 3], pax2_lpt250=Pax2_lap[3, :, 4])
