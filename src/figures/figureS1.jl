...
function figureS1()
    ...
    p7 = DrugResponseModel.plot_fig1(concs[:, 1], G1ref[:, :, 1], g1m[:, :, 1, 1], "Lapatinib", "G1", "h")
    p8 = DrugResponseModel.plot_fig1(concs[:, 1], G2ref[:, :, 1], g2m[:, :, 1, 1], "Lapatinib", "G2", "i")
    p9 = DrugResponseModel.plot_fig1(concs[:, 2], G1ref[:, :, 2], g1m[:, :, 2, 1], "Doxorubicin", "G1", "j")
    p10 = DrugResponseModel.plot_fig1(concs[:, 2], G2ref[:, :, 2], g2m[:, :, 2, 1], "Doxorubicin", "G2", "k")
