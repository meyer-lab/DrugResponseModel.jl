...
function output_Bliss_cellnum()
    ...
    df1 =
        DataFrames.DataFrame(plb50_lpt25 = bliss[2, 3, 4], plb50_lpt50 = bliss[3, 3, 4], plb50_lpt100 = bliss[4, 3, 4], plb50_lpt250 = bliss[5, 3, 4])
    df2 =
        DataFrames.DataFrame(gem10_lpt25 = bliss[2, 3, 2], gem10_lpt50 = bliss[3, 3, 2], gem10_lpt100 = bliss[4, 3, 2], gem10_lpt250 = bliss[5, 3, 2])
