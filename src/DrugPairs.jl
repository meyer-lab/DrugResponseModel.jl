...
function estimated_params(concs, key)
    ...
    # 3. lpt and tax:
    p3 = [33.3703, 1.19243, 0.0331291, 0.0442161, 0.513058, 0.678679, 0.0157238, 0.00394221, 0.00692375, 1.16954e-9, 0.531837, 2.97956, 2.88671, 1.71067, 0.0638964, 2.0, 0.336735, 9.77487e-9, 0.0430892, 1.09105e-8, 0.00231518, 0.498326, 2.0, 0.203987, 0.725018, 0.568974];
    # 4. lpt and palbo:
    # 5. dox and gem:
    p5 = [19.5133, 2.01514, 0.0221494, 0.456167, 0.390407, 2.0, 0.0205179, 0.0069432, 1.01511e-9, 0.14444, 0.531249, 5.79555, 1.60752, 0.300264, 0.492173, 0.190679, 0.990212, 1.0469e-9, 1.06128e-9, 0.0279224, 1.18084e-9, 0.441948, 2.0, 0.206729, 0.939593, 0.468727];
    # 6. dox and tax:
    p6 = [19.8052, 1.61367, 0.0272342, 0.501662, 0.474784, 2.0, 0.0242529, 0.0488431, 1.02986e-9, 0.0805864, 0.579608, 3.80863, 2.51815, 0.0918445, 1.64435e-9, 2.0, 0.0720509, 1.51462e-9, 0.0288849, 0.0319411, 0.0186419, 0.494724, 2.0, 0.201878, 0.718836, 0.585565];
    # 7. dox and palbo:
    # 8. gem and tax:
    p8 = [9.7291, 1.9724, 0.515963, 1.46484, 1.16859, 2.0, 0.0371012, 4.15166e-7, 1.69266e-7, 0.128604, 0.459572, 2.97266, 2.94866, 1.8291, 0.0649484, 2.0, 0.361753, 7.58154e-8, 0.0446008, 1.75339e-7, 1.55382e-7, 0.504308, 2.0, 0.205093, 0.838779, 0.522651];
    # 9. gem and palbo:
    # 10. tax and palbo:
