...
function output_loewe()
    ...
    df4 = DataFrames.DataFrame(plb50_gem5=gemc_palbo[5, 3], plb50_gem10=gemc_palbo[6, 3], plb50_gem17=gemc_palbo[7, 3], plb50_gem30=gemc_palbo[8, 3])
    df5 = DataFrames.DataFrame(lpt100_palbo25=lapatinib_palbo[6, 4], lpt100_palbo50=lapatinib_palbo[6, 5], lpt100_palbo100=lapatinib_palbo[6, 6], lpt100_palbo250=lapatinib_palbo[6, 7])
    df6 = DataFrames.DataFrame(lpt100_gem5=lapatinib_gemc[6, 5], lpt100_gem10=lapatinib_gemc[6, 6], lpt100_gem17=lapatinib_gemc[6, 7], lpt100_gem30=lapatinib_gemc[6, 8])
    df7 = DataFrames.DataFrame(gem10_palbo25=gemc_palbo[6, 4], gem10_palbo50=gemc_palbo[6, 5], gem10_palbo100=gemc_palbo[6, 6], gem10_palbo250=gemc_palbo[6, 7])
