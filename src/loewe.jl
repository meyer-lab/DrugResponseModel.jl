...
function output_loewe()
    ...
    df1 = DataFrames.DataFrame(
        plb50_lpt25 = lapatinib_palbo[2, 2],
        plb50_lpt50 = lapatinib_palbo[3, 2],
        plb50_lpt100 = lapatinib_palbo[4, 2],
        plb50_lpt250 = lapatinib_palbo[5, 2],
    )
    df2 = DataFrames.DataFrame(
        gem10_lpt25 = lapatinib_gemc[2, 3],
        gem10_lpt50 = lapatinib_gemc[3, 3],
        gem10_lpt100 = lapatinib_gemc[4, 3],
        gem10_lpt250 = lapatinib_gemc[5, 3],
    )
    ...
    df4 = DataFrames.DataFrame(
        plb50_gem5 = gemc_palbo[2, 3],
        plb50_gem10 = gemc_palbo[3, 3],
        plb50_gem17 = gemc_palbo[4, 3],
        plb50_gem30 = gemc_palbo[5, 3],
    )
    df5 = DataFrames.DataFrame(
        lpt100_palbo25 = lapatinib_palbo[4, 2],
        lpt100_palbo50 = lapatinib_palbo[4, 3],
        lpt100_palbo100 = lapatinib_palbo[4, 4],
        lpt100_palbo250 = lapatinib_palbo[4, 5],
    )
    df6 = DataFrames.DataFrame(
        lpt100_gem5 = lapatinib_gemc[4, 2],
        lpt100_gem10 = lapatinib_gemc[4, 3],
        lpt100_gem17 = lapatinib_gemc[4, 4],
        lpt100_gem30 = lapatinib_gemc[4, 5],
    )
    df7 = DataFrames.DataFrame(
        gem10_palbo25 = gemc_palbo[3, 2],
        gem10_palbo50 = gemc_palbo[3, 3],
        gem10_palbo100 = gemc_palbo[3, 4],
        gem10_palbo250 = gemc_palbo[3, 5],
    )
