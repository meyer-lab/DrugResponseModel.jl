...
function residHill(
    ...
    for ii = 1:length(concentrations)
        ...
        alpha = hill(
            [hillParams[1], hillParams[2], hillParams[3], hillParams[4]],
            concentrations[ii],
        )
        beta = hill(
            [hillParams[1], hillParams[5], hillParams[6], hillParams[4]],
            concentrations[ii],
        )
        gamma1 =
            hill([hillParams[7], 0.0, hillParams[8], hillParams[9]], concentrations[ii])
        gamma2 =
            hill([hillParams[7], 0.0, hillParams[10], hillParams[9]], concentrations[ii])
...
function optimize_hill(
    ...
    residue(hillParams) =
        residHill(hillParams, concentrations, g1, g2, g1_0, g2_0, nG1, nG2)
    # lower bound
